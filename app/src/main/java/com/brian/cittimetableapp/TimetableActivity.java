...
public class TimetableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String classGroupName = bundle.getString("selectedClass");
        setTitle(classGroupName + "'s " + getString(R.string.timetable));
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        final TextView textview00 = findViewById(R.id.timeSlot00);
        final String[] module00 = fillTimeSlot(database, classGroupName, "0", "0", textview00);
        textview00.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                intent.putExtra("classGroupName", bundle.getString("selectedClass"));
                intent.putExtra("moduleName", module00[0]);
                startActivity(intent);
            }
        });
        TextView textview01 = findViewById(R.id.timeSlot01);
        final String[] module01 = fillTimeSlot(database, classGroupName, "0", "1", textview01);
        ...
        final String[] module02 = fillTimeSlot(database, classGroupName, "0", "2", textview02);
        ...
        final String[] module03 =  fillTimeSlot(database, classGroupName, "0", "3", textview03);
        ...
        final String[] module04 = fillTimeSlot(database, classGroupName, "0", "4", textview04);
        ...
        final String[] module05 = fillTimeSlot(database, classGroupName, "0", "5", textview05);
        ...
        final String[] module06 = fillTimeSlot(database, classGroupName, "0", "6", textview06);
        ...
        final String[] module07 = fillTimeSlot(database, classGroupName, "0", "7", textview07);
        ...
        final String[] module08 = fillTimeSlot(database, classGroupName, "0", "8", textview08);
        ...
        final String[] module10 = fillTimeSlot(database, classGroupName, "1", "0", textview10);
        ...
        final String[] module11 = fillTimeSlot(database, classGroupName, "1", "1", textview11);
        ...
        final String[] module12 = fillTimeSlot(database, classGroupName, "1", "2", textview12);
        ...
        final String[] module13 = fillTimeSlot(database, classGroupName, "1", "3", textview13);
        ...
        final String[] module14 = fillTimeSlot(database, classGroupName, "1", "4", textview14);
        ...
        final String[] module15 = fillTimeSlot(database, classGroupName, "1", "5", textview15);
        ...
        final String[] module16 = fillTimeSlot(database, classGroupName, "1", "6", textview16);
        ...
        final String[] module17 = fillTimeSlot(database, classGroupName, "1", "7", textview17);
        ...
        final String[] module18 = fillTimeSlot(database, classGroupName, "1", "8", textview18);
        ...
        final String[] module20 = fillTimeSlot(database, classGroupName, "2", "0", textview20);
        ...
        final String[] module21 = fillTimeSlot(database, classGroupName, "2", "1", textview21);
        ...
        final String[] module22 = fillTimeSlot(database, classGroupName, "2", "2", textview22);
        ...
        final String[] module23 = fillTimeSlot(database, classGroupName, "2", "3", textview23);
        ...
        final String[] module24 = fillTimeSlot(database, classGroupName, "2", "4", textview24);
        ...
        final String[] module25 = fillTimeSlot(database, classGroupName, "2", "5", textview25);
        ...
        final String[] module26 = fillTimeSlot(database, classGroupName, "2", "6", textview26);
        ...
        final String[] module27 = fillTimeSlot(database, classGroupName, "2", "7", textview27);
        ...
        final String[] module28 = fillTimeSlot(database, classGroupName, "2", "8", textview28);
        ...
        final String[] module30 = fillTimeSlot(database, classGroupName, "3", "0", textview30);
        ...
        final String[] module31 = fillTimeSlot(database, classGroupName, "3", "1", textview31);
        ...
        final String[] module32 = fillTimeSlot(database, classGroupName, "3", "2", textview32);
        ...
        final String[] module33 = fillTimeSlot(database, classGroupName, "3", "3", textview33);
        ...
        final String[] module34 = fillTimeSlot(database, classGroupName, "3", "4", textview34);
        ...
        final String[] module35 = fillTimeSlot(database, classGroupName, "3", "5", textview35);
        ...
        final String[] module36 = fillTimeSlot(database, classGroupName, "3", "6", textview36);
        ...
        final String[] module37 = fillTimeSlot(database, classGroupName, "3", "7", textview37);
        ...
        final String[] module38 = fillTimeSlot(database, classGroupName, "3", "8", textview38);
        ...
        final String[] module40 = fillTimeSlot(database, classGroupName, "4", "0", textview40);
        ...
        final String[] module41 = fillTimeSlot(database, classGroupName, "4", "1", textview41);
        ...
        final String[] module42 = fillTimeSlot(database, classGroupName, "4", "2", textview42);
        ...
        final String[] module43 = fillTimeSlot(database, classGroupName, "4", "3", textview43);
        ...
        final String[] module44 = fillTimeSlot(database, classGroupName, "4", "4", textview44);
        ...
        final String[] module45 = fillTimeSlot(database, classGroupName, "4", "5", textview45);
        ...
        final String[] module46 = fillTimeSlot(database, classGroupName, "4", "6", textview46);
        ...
        final String[] module47 = fillTimeSlot(database, classGroupName, "4", "7", textview47);
        ...
        final String[] module48 = fillTimeSlot(database, classGroupName, "4", "8", textview48);
